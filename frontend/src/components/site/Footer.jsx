    ...
    <div className="max-w-[1240px] mx-auto px-4 md:px-8 py-16 grid md:grid-cols-12 gap-10">
      ...
      <div className="md:col-span-4">
        ...
        <ul className="space-y-4 font-body">
          ...
          <li>
            <a href={BRAND.email2Href} className="flex items-center gap-3 text-white/80 hover:text-[#E4141B] transition-colors">
              <EnvelopeSimple size={18} weight="fill" /> {BRAND.email2}
            </a>
          </li>
